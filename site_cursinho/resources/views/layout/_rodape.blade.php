<footer class="footer">
    ...
    <ul>
        <li><a href="{{ route('redirect', ['page' => 'home']) }}">Home</a></li>
        <li><a href="{{ route('listar.redacoes_corrigidas', ['cpf' => auth()->user()->cpf]) }}">Redações Corrigidas</a></li>
        <li><a href="{{ route('redacao.list_aluno_para_aluno', ['cpf' => auth()->user()->cpf]) }}">Redações Enviadas</a></li>
        <li><a href="{{ route('redirect', ['page' => 'redacao']) }}">Redação</a></li>
        <li><a href="{{route('aluno_listar_exercicio')}}">Exercícios</a></li>
        <li><a href="{{route('materiais')}}">Matérias</a></li>
        <li><a href="{{ asset('HELP_ALUNO.pdf') }}" target="_blank">Baixar Manual de Uso</a></li>
    </ul>
