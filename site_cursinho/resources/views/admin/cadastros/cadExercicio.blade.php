...
<html lang="pt-br">
    ...
    <div class="logo">
        ...
        @component('components.card_form')
            ...
            @slot('required')
                value="{{isset($linha->imagem_exercicio) ? $linha->imagem_exercicio : ''}}"
            @endslot
        ...
        @endcomponent
            ...
            @slot('required')
                required value="{{isset($linha->correcao_exercicio) ? $linha->correcao_exercicio : ''}}"
            @endslot
        ...
        @component('components.card_form')
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Último Exercício Cadastrado: {{$maiorIdExercicio}}.</p>
                ...
                <div class="form-row submit-btn">
                    ...
                    <a href="{{route('admin.cadastro_alternativa')}}" class="addBtn">Cadastro de alternativas</a><br><br><br>
                </div>
            </div>
            </form>
        </div>
