            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><div class="ellipsis">{{$row->descricao_professor}}</td>
                        <td>{{$row->imagem_professor}}</td>
                            ...
                            <div class="popup-box">
                                ...
                                <a href="{{ route('admin.professor.excluir',['email_professor' => $row->email_professor, 'cpf_professor' => $row->cpf_professor])}}" id="confirmDelete">Sim</a>
