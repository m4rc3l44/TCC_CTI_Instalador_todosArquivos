            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@if($row->corrigida === true)
                                Já corrigida
                            @endif</td>
                        <td>
                            
                            <a href="{{asset($row->nome_arquivo)}}" download class="btn-edit" style='text-decoration:none;'><ion-icon name="download-outline" ></ion-icon></a>
                            <a href="{{ route('cadastro-redacoes-corrigidas', ['cpf_aluno' => $row->aluno->cpf_aluno, 'tema_redacao' => $row->fk_tema]) }}" class="btn-edit" style='text-decoration:none;'>Corrigir <ion-icon name="cloud-upload-outline"></ion-icon>
