...
<body> -->
    ...
    <form action="{{ route('exercicio.search_aluno') }}" method="get" enctype='multipart/form-data'>
        <div class="barra_pesquisa">
            ...
            <select name="Materia" id="select1" class="select">
                <option value="todos">Selecionar todas as matérias:</option>
            ...
            <select name="Assunto" id="select3" class="select">
                <option value="todos">Selecionar todos os assuntos:</option>
            ...
            <select name="Vestibular" id="select4" class="select">
                <option value="todos">Selecionar todos os vestibulares:</option>
            ...
            <select name="Ano" id="select5" class="select">
                ...
                <option value="todos">Selecionar todos os anos:</option>
                        ...
                        <center>
                                ...
                                @foreach (session('exercicios') as $exercicio)
                                    @if (!is_null($exercicio['resposta_certa_errada']))
                                        ...
                                        @elseif($exercicio['resposta_certa_errada'] == 'errada' && $exercicio['id_exercicio'] == $alternativa->fk_id_exercicio  && !is_null($exercicio['alternativa_respondida']))
                                            ...
                                            @if(!is_null($row->correcao_exercicio))     <div class="resposta-incorreta"> {{$row->correcao_exercicio}}  </div> @endif
                                            @if(!is_null($row->imagem_correcao_exercicio))   <img src="{{ asset($row->imagem_correcao_exercicio) }}" alt="imagem_homepage" width="35%"><br> @endif
                                        @elseif(
                            ...
                            @if (session('exercicios'))
                                ...
                                @if ($ultimoExercicio['id_exercicio'] == $alternativa->fk_id_exercicio)
                                    <a class="exercicio1" name="exercicio_atual" style="display: hidden;"></a>
                                @endif
                            @endif
    ...
    document.addEventListener("DOMContentLoaded", function() {
        // Rolar a tela até o elemento com a classe .exercicio1
        const exercicioElement = document.querySelector('.exercicio1');
        if (exercicioElement) {
            exercicioElement.scrollIntoView({ behavior: "smooth" });
        }
    });
</script>
    @if (auth()->user()->nivel === 'admin')
