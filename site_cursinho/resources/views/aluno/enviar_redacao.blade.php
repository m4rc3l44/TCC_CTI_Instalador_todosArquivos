...
@if(auth()->user()->nivel === 'admin')
    ...
    <div class="mamae">
        ...
        <form action="{{route('redacao_aluno.update', ['titulo' => urlencode($titulo), 'fk_cpf_aluno' => auth()->user()->cpf])}}" method="post" enctype='multipart/form-data'>
            {{csrf_field() }}
            ...
            <input type="hidden" value = "{{$titulo}}" name="fk_tema"> -->
                ...
                <!-- &nbsp;&nbsp;&nbsp;&nbsp;<a href="" download class="btn-edit" style='text-decoration:none;'><ion-icon name="download-outline" ></ion-icon>&nbsp;&nbsp;Baixar Materiais</a> -->
                <br><br>
        </form>
