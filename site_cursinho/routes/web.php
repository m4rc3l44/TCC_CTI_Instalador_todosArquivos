...
Route::middleware(['auth.check'])->group(function () {
    ...
    Route::middleware(['auth.check.usuario'])->group(function () {
        ...
        Route::put('/editar/redacao_enviada/{id_redacao}/{fk_cpf_aluno}', [RedacaoController::class, 'update_redacao_enviada'])->name('admin.redacao_enviada.update');
        ...
        Route::post('/salvar_redacao_aluno/{titulo}/{fk_cpf_aluno}', [RedacaoController::class, 'update_redacao_aluno'])->name('redacao_aluno.update');
